...
// Mapowanie kolorów z bazy danych na nazwy katalogów (zgodnie z rzeczywistą strukturą)
  ...
  try {
    ...
    if (matType === '3d-with-rims') {
      ...
      if (cellStructure === 'rhombus') {
        ...
        fileName = `5os-3d-honey-${materialColor}-${borderColor}.webp`;
      }
...
async function fixImagePaths() {
  try {
    console.log('🔧 Rozpoczynam naprawę imagePath w tabeli CarMat (poprawiona wersja)...\n');
